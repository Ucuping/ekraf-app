...
<html lang="en">
  <head>
    ...
    <link
      href="assets1/vendor/bootstrap/css/bootstrap.min.css"
      rel="stylesheet"
    />
    <link
      href="assets1/vendor/bootstrap-icons/bootstrap-icons.css"
      rel="stylesheet"
    />
      ...
      <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img class="img-responsive" src="assets1/img/Jfc3.png" alt="slider">
            ...
            <div class="carousel-item">
                <img class="img-responsive" src="assets1/img/jff.jfif" alt="slider">
                <div class="slider-content">
                    <div class="col-md-12 text-center">
                        <h1 class="animated2">
          ...
          <div class="row" data-aos="zoom-in" data-aos-delay="100">
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="course-item">
                <img src="assets1/img/berita1.jpeg" class="img-fluid" alt="..."/>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="course-item">
                <img style="height: 310px;" src="assets1/img/berita2.jpeg" class="img-fluid" alt="..."/>
                <div class="course-content">
                  <div class="post-details mt-2 mb-4">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="course-item">
                <img style="height: 310px;" src="assets1/img/berita3.jpeg" class="img-fluid" alt="..."/>
                <div class="course-content">
                  <div class="post-details mt-2 mb-4">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="course-item">
                <img style="height: 310px;" src="assets1/img/berita4.jpeg" class="img-fluid" alt="..."/>
                <div class="course-content">
                  <div class="post-details mt-2 mb-4">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
              <div class="course-item">
                <img style="height: 310px;" src="assets1/img/berita5.jpeg" class="img-fluid" alt="..."/>
                <div class="course-content">
                  <div class="post-details mt-2 mb-4">
    ...
    <footer class="style-1 d-flex flex-row p-3">
      <div class="container ">
          <div class="row">
              ...
              <div class="col-md-4">
                  <h4 class="mt-4 fw-bold"><a href="/home">www.E-KrafJember.co.id</a></h4>
              </div>
          </div>
      </div>
    </footer>
