...
<div class="text-sm-end mb-3 text-center">
    ...
    <a class="btn btn-primary btn-sm" type="button" data-toggle="ajax" target="_blank" href="{{ route('apps.validations.print', $data->hashid) }}" {{ $data->status != 'pending' ? 'disabled' : '' }}><i class="fas fa-print"></i> Cetak</a>
    <button class="btn btn-success btn-sm" type="button" data-toggle="approved" data-id="{{ $data->hashid }}" data-callback="{{ route('apps.validations') }}" {{ $data->status != 'pending' ? 'disabled' : '' }}><i class="fas fa-check"></i> Verifikasi</button>
    <button class="btn btn-danger btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#myModal" data-toggle="rejected" {{ $data->status != 'pending' ? 'disabled' : '' }}><i class="fas fa-times"></i> Tolak</button>
</div>
<div class="row">
    <div class="col-lg-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    ...
                                                    <h6 class="fs-15 mb-0">{{ $data->status == 'pending' ? 'Menunggu Diverifikasi' : ($data->status == 'approved' ? 'Terverifikasi' : 'Ditolak') }}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
