...
<div class="text-sm-end mb-3 text-center">
    <button class="btn btn-dark btn-sm" type="button" data-toggle="ajax" data-target="{{ route('apps.companies') }}">Kembali</button>
    <button class="btn btn-primary btn-sm" type="button" data-toggle="ajax" data-target="{{ route('apps.companies.edit', $data->hashid) }}"><i class="fas fa-edit"></i> Edit</button>
</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
                                                    ...
                                                    <h6 class="fs-15 mb-0">{!! $data->facebook_username != null ? '<a href="https://www.facebook.com/' . $data->facebook_username . '"' . ' target="_blank" rel="noopener noreferrer">Lihat</a>' : '-' !!}</h6>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-sm-6">
                                                <div>
